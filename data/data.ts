export const personalInfo = {
  ...
  description:
    "Hello! I'm Hira Khalid a passionate Full Stack Web Developer with a strong background in web development. I specialize in building robust and user-friendly web applications using a wide range of technologies. ",
...
export const aboutInfo = {
  ...
  description:
    "At Hira  warriors, we’re a dedicated team of designers and developers committed to delivering tailored web solutions. With a blend of creativity and technical expertise, we help businesses elevate their online presence and achieve their goals",
  client: "00+",
  experience: "00+",
  project: "10+",
  website: "2+",
...
export const contactData = {
  phone: "+92 333 3604659",
  email: "hirakhalidgd123@gmail.com",
  address: "Kharachi , Pakistan",
};
